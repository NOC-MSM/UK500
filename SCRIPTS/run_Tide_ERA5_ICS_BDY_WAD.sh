...
export EXP=$WDIR/RUN_DIRECTORIES/EXP_Tide_ERA5_ICS_BDY_WAD
...
#Link nemo mask
rm $EXP/nemo_mask.nc
ln -s $DOMAIN/nemo_mask.nc $EXP/nemo_mask.nc
...
# Link in initial conditions (you have prepared these ahead of time from a parent model)
ln -s $WDIR/INPUTS/ICS/  $EXP/.
